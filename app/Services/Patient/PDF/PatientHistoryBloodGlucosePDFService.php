...
class PatientHistoryBloodGlucosePDFService extends PatientHistoryPDFService{

    protected $repository;

    public function __construct( User $patient = null, $filters = null, $title = 'PATIENT BLOOD GLUCOSE HISTORY ', $name = null)
    {
        ...
        $this->repository = (new PatientBloodGlucoseRepository())->forPatient($patient->id);
    ...
    public function setDataPDF(){
        ...
        $graphUrl = $this->generateImageUrl($data->toArray(), $this->filters, 'blood_glucose');
        ...
        $this->pdf->loadView('pdf.patient.reports.bloodGlucose', $pdfData);
    }
}
