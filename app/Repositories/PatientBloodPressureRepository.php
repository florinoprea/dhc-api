...
class PatientBloodPressureRepository extends AppRepository implements PatientBloodPressureRepositoryInterface
{
    use TimezoneAwareTrait;

    protected $modelName = PatientBloodPressure::class;
    ...
    public function add($patientId, $attributes)
    {
        ...
        try {
            ...
            $modelData = $this->model->create([
                ...
                'systolic' => $attributes['systolic'],
                'diastolic' => $attributes['diastolic'],
