...
<main>
        ...
        <div class="block row">
            <div class="col-md-12">
                <table class="table">
                    <thead >
                        <tr >
                            <th class="text-left" >SYS/DIA &bull; PULSE</th>
                        ...
                        @foreach ($data as $info)
                            <tr class="">
                                <td class="text-left " style="vertical-align:top">
                                    {{ $info->systolic }}/{{ $info->diastolic }} mmHg SYS/DIA &bull; {{ $info->pulse }} PULSE/min
                                </td>
                                <td class="text-left" style="vertical-align:top">
    ...
    @else
        <div class="text-center">No blood pressure readings.</div>
    @endif
